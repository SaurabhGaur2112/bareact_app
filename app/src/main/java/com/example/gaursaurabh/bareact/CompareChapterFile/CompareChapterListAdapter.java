package com.example.gaursaurabh.bareact.CompareChapterFile;
...
import com.example.gaursaurabh.bareact.CompareSection;
...
public class CompareChapterListAdapter extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<ChapterFeedItem> chapterFeedItems;

    public CompareChapterListAdapter(Activity activity, List<ChapterFeedItem> chapterFeedItems){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        chapter_card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(activity, CompareSection.class);
