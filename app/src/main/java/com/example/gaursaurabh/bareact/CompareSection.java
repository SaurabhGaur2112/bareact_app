...
import com.example.gaursaurabh.bareact.CompareSectionFile.CompareSectionListAdapter;
...
public class CompareSection extends AppCompatActivity {

    String chapterId;
    private static final String TAG = CompareSection.class.getSimpleName();
    private ListView listView;
    private CompareSectionListAdapter listAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_compare_section);

        listView = (ListView) findViewById(R.id.compareSectionList);
        progressBar = (ProgressBar) findViewById(R.id.compareSectionProgress);

        sectionFeedItems = new ArrayList<SectionFeedItem>();

        listAdapter = new CompareSectionListAdapter(this, sectionFeedItems);
