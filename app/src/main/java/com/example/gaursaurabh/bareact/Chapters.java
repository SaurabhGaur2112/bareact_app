...
public class Chapters extends AppCompatActivity {
    ...
    String bareactId;
    private static final String TAG = Chapters.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar) findViewById(R.id.chapterProgress);

        chapterFeedItems = new ArrayList<ChapterFeedItem>();

        listAdapter = new ChapterListAdapter(this, chapterFeedItems);
